...
public class SearchItem extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * != null) { //Get the username sent from the client String username =
		 * request.getParameter("username"); //In the output stream, add something to
		 * response body. out.print("Hello " + username); } // Send response back to
		 * client out.close();
		 */
